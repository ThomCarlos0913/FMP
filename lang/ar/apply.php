...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>تطبيق | Forever Manpower</title>
  ...
  <body>
    ...
    <div class="emailoverlay">
      ...
      <div class="deleteapproval">
        <p class="approvalheader">حذف التأكيد</p>
        <p class="approvalmessage">هل أنت متأكد أنك تريد حذف ما يلي<br /> إدخال التطبيق؟</p>
        <div class="approvalbtncontainers d-flex justify-content-end align-items-end">
          <button onclick="hideOverlays()" class="approvalbtns button-approval btn-outline-secondary" type="button" name="button">لا</button>
          <button class="approvalbtns deleteapproved button-approval btn-danger" type="button" name="button">نعم</button>
        </div>
      </div>
    </div>
    <!-- Start Of Navigation -->
    <nav class="navbar navbar-expand-md bg-light navbar-light">
      ...
      <div class="collapse navbar-collapse" id="collapse_navbar">
        ...
        <ul class="navbar-list-container navbar-list navbar-nav">
          ...
          <li class="nav-item"><a class="nav-link nav-selected" href="#">قدم الآن</a></li>
        </ul>
        <ul class="navbar-list-container navbar-list navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown_languages">
              <a class="dropdown-item" href="../../apply.php">الإنجليزية</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="../../lang/chn/apply.php">صينى</a>
              <div class="dropdown-divider"></div>
    ...
    <?php if ((isset($_SESSION['is_loggedin']) && $_SESSION['is_loggedin'])) {?>
      ...
      <div class="user-page">
        ...
        <div class="container">
          <div class="btn-group" role="group" aria-label="Basic example">
            <button type="button" class="btn btn-secondary active" onclick="changeTab(0);">حالة التطبيق</button>
            <button type="button" class="btn btn-secondary" onclick="changeTab(1); initializeFirstApplicationTab();">أرسل التطبيق</button>
          </div>
        </div>
      ...
      <div class="account-navigation-container">
        ...
        <div class="container send-application">
          <form class="send-application-form" action="php/sendapplication.php" method="post" enctype="multipart/form-data">
            <div class="row">
              <div class="col-sm-3">
                <ul class="list-group">
                  <li class="list-group-item header">تقدم التطبيق</li>
                  <li class="list-group-item d-flex">تفاصيل شخصية <img class="pointer ml-auto" src="../../styles/resources/images/arrow-left.svg" width="15px" alt=""> </li>
                  <li class="list-group-item d-flex">الحالة الزوجية <img class="pointer ml-auto" src="../../styles/resources/images/arrow-left.svg" width="15px" alt=""></li>
                  <li class="list-group-item d-flex">أقارب <img class="pointer ml-auto" src="../../styles/resources/images/arrow-left.svg" width="15px" alt=""></li>
                  <li class="list-group-item d-flex">الاتصالات والعنوان <img class="pointer ml-auto" src="../../styles/resources/images/arrow-left.svg" width="15px" alt=""></li>
                  <li class="list-group-item d-flex">التعليم <img class="pointer ml-auto" src="../../styles/resources/images/arrow-left.svg" width="15px" alt=""></li>
                  <li class="list-group-item d-flex">توظيف <img class="pointer ml-auto" src="../../styles/resources/images/arrow-left.svg" width="15px" alt=""></li>
                  <li class="list-group-item d-flex">صورة وتطبيق الوظيفة <img class="pointer ml-auto" src="../../styles/resources/images/arrow-left.svg" width="15px" alt=""></li>
                </ul>
              </div>
              <div class="col-sm-9">
                ...
                <div class="application-tab">
                  <div class="d-flex justify-content-between">
                    ...
                    <div>
                      <p class="message-asterisks">ملاحظة: الحقول ذات العلامة النجمية (*) مطلوبة. إذا لم يكن لديك اسم الأوسط يرجى إدخال 'n/a'</p>
                    </div>
                  </div>
                  <!-- Firstname, Middlename, Surname -->
                  <div class="row">
                    <div class="col-sm-4">
                      <label for="">الاسم الاول <span class="important">*</span></label>
                      <input class="textbox" type="text" name="firstname" value="<?php echo $_SESSION['firstname']?>">
                    </div>
                    <div class="col-sm-4">
                      <label for="">الاسم الوسطى <span class="important">*</span></label>
                      <input class="textbox" type="text" name="middlename" value="">
                    </div>
                    <div class="col-sm-4">
                      <label for="">لقب <span class="important">*</span></label>
                  ...
                  <div class="row">
                    <div class="col-sm-5">
                      <label>لغة</label><br />
                      <input type="checkbox" name="languages" class="langcheck" value="English"><label class="radio-checkbox-label">الإنجليزية</label>
                      <input type="checkbox" name="languages" class="langcheck" value="Tagalog"><label class="radio-checkbox-label">التغالوغ</label>
                      <input type="checkbox" name="languages" class="langcheck" value="Other"><label class="radio-checkbox-label">آخر</label>
                      <input class="textbox langcheck"type="text" name="languages-text" placeholder="Fill if others is checked. Ex. Nihongo">
                      <p class="otherlangmess">يرجى ملء مربع النص بلغات أخرى أعلاه</p>
                    </div>
                    <div class="col-sm-6">
                      <label>دين</label><br />
                      <input type="checkbox" name="religion" value="Catholic"><label class="radio-checkbox-label">كاثوليكي</label>
                      <input type="checkbox" name="religion" value="Christian"><label class="radio-checkbox-label">مسيحي</label>
                      <input type="checkbox" name="religion" value="Muslim"><label class="radio-checkbox-label">مسلم</label>
                    </div>
                  </div>
                </div>
                <!-- Marital Status -->
                <div class="application-tab">
                  <div class="d-flex justify-content-between">
                    ...
                    <div>
                      <p class="message-asterisks">ملاحظة: الحقول ذات العلامة النجمية (*) مطلوبة</p>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-3">
                      <label>الحالة الزوجية <span class="important">*</span></label>
                      <select class="select-box" name="maritalstatus">
                        <option value="Single">غير مرتبطة</option>
                        <option value="Married">متزوج</option>
                        <option value="Separated">منفصل</option>
                        <option value="Single Parent">الوالد الوحيد</option>
                        <option value="Live-in">الوالد الوحيد</option>
                ...
                <div class="application-tab">
                  ...
                  <div class="row">
                    <div class="col-sm-9">
                      <label>إحراز <span class="important">*</span></label><br />
                      <input type="radio" name="attainment" value="High School"><label class="radio-checkbox-label">المدرسة الثانوية</label>
                        <input type="radio" name="attainment" value="Vocational / Technical / TESDA"><label class="radio-checkbox-label">مهني/ فني / TESDA</label>
                      <input type="radio" name="attainment" value="University"><label class="radio-checkbox-label">كلية / جامعة</label>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-4">
                      <label>دورة <span class="important">*</span></label>
                      <input class="textbox" type="text" name="course" placeholder="Ex. BS Computer Engineering">
                    </div>
                    <div class="col-sm-2">
                      <label>سنوات الدراسة <span class="important">*</span></label>
                      <input class="textbox" type="text" name="studyyears" placeholder="Ex. 5">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-3">
                      <label>تخرج <span class="important">*</span></label><br />
                      <input type="radio" name="graduated" value="yes"><label class="radio-checkbox-label">نعم</label>
                      <input type="radio" name="graduated" value="no"><label class="radio-checkbox-label">لا</label>
                    </div>
                  </div>
                </div>
                <div class="application-tab">
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      <label>صاحب العمل <span class="important">*</span></label>
                      <input class="textbox" type="text" name="employer" placeholder="Ex. Jacob Daniel">
                    </div>
                    <div class="col-sm-4">
                      <label>بلد/سنوات من الى <span class="important">*</span></label>
                      <input class="textbox" type="text" name="countryyeasfromto" placeholder="">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-4">
                      <label>المنتج/صناعة <span class="important">*</span></label>
                      <input class="textbox" type="text" name="productindustry" placeholder="">
                    </div>
                    <div class="col-sm-4">
                      <label>موضع <span class="important">*</span></label>
                      <input class="textbox" type="text" name="position" placeholder="">
                    </div>
                    <div class="col-sm-4">
                      <label>اترك السبب<span class="important">*</span></label>
                      <input class="textbox" type="text" name="leavereason" placeholder="">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-4">
                      <label>صاحب العمل (2)</label>
                      <input class="textbox" type="text" name="employer2" placeholder="">
                    </div>
                    <div class="col-sm-4">
                      <label>بلد/سنوات من الى (2)</label>
                      <input class="textbox" type="text" name="countryyeasfromto2" placeholder="">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-4">
                      <label>المنتج/صناعة (2)</label>
                ...
                <div class="application-tab">
                  ...
                  <div class="row">
                    <div class="col-sm-5">
                      <label>قم بتحميل 2 × 2 أو صورة بحجم جواز السفر <span class="important">*</span></label>
                      <div class="image d-flex justify-content-center align-items-center">
                        <img id="targetImg" class="user-image" src="../../styles/resources/images/user.svg" width="192px" height="192px" alt="">
                      </div>
                      <label class="file-upload"> اختر صورة
                        <input id="picturesrc" type="file" size="100" name='image' onchange="loadFile(event)" >
                      </label>
                    </div>
                    <div class="col-sm-6">
                      <label>يرجى التحقق من طلب الوظيفة المطلوب <span class="important">*</span></label>
                      <div class="row">
                        <div class="col-sm-6">
                          <label>Taiwan</label><br />
                          <input type="checkbox" name="job1" <?php if (strpos($_SESSION['applications'], "Male Factory Worker") > 0) { ?> disabled="disabled" <?php } ?> value="Male Factory Worker"><label class="radio-checkbox-label">عامل مصنع ذكر</label><br/>
                          <input type="checkbox" name="job2" <?php if (strpos($_SESSION['applications'], "Female Factory Worker") > 0) { ?> disabled="disabled" <?php } ?> value="Female Factory Worker"><label class="radio-checkbox-label">عامل مصنع أنثى</label><br/>
                          <input type="checkbox" name="job3" <?php if (strpos($_SESSION['applications'], "Male Nursing Aide") > 0) { ?> disabled="disabled" <?php } ?> value="Male Nursing Aide"><label class="radio-checkbox-label">مساعد التمريض الذكور</label><br/>
                          <input type="checkbox" name="job4" <?php if (strpos($_SESSION['applications'], "Female Nursing Aide") > 0) { ?> disabled="disabled" <?php } ?> value="Female Nursing Aide"><label class="radio-checkbox-label">مساعد تمريض أنثى</label><br/>
                          <input type="checkbox" name="job5" <?php if (strpos($_SESSION['applications'], "Female Caretakers") > 0) { ?> disabled="disabled" <?php } ?> value="Female Caretakers"><label class="radio-checkbox-label">القائمين على الإناث</label><br/>
                        </div>
                        <div class="col-sm-6">
                          <label>Oman / Saudi / Qatar</label><br />
                          <input type="checkbox" name="job6" <?php if (strpos($_SESSION['applications'], "Female Domestic Helpers")> 0) { ?> disabled="disabled" <?php } ?> value="Female Domestic Helpers"><label class="radio-checkbox-label">عاملات المنازل</label><br/>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <!-- Submit tab -->
                <div class="d-flex justify-content-end">
                  <button id="incomplete-details" class="changebtn" type="button" name="button" onclick=""> <img src="styles/resources/images/exclamation-circle.svg" width="15px" alt="exclamation image"> يرجى ملء جميع التفاصيل اللازمة.</button>
                  <button id="prev-btn" class="changebtn" type="button" name="button" onclick="showApplicationTab('sub')">السابق</button>
                  <button id="next-btn" class="changebtn" type="button" name="button" onclick="showApplicationTab('add')">التالى</button>
                  <button id="submit-btn" type="button" name="button" onclick="checkSubmit()">قدم الطلب</button>
                </div>
              </div>
            </div>
          </form>
        ...
        <div class="container application-status">
          <p class="application-list">قائمة حالة التطبيق</p>
          <?php if (isset($_SESSION['applications']) && !preg_match("/[a-zA-Z]/", $_SESSION['applications'])) { ?>
            <div class="empty-application">
              ...
              <p> لم ترسل أي طلبات حتى الآن.</p>
              <p>لملء الطلب ، انقر فوق الزر "إرسال التطبيق" أعلاه.</p>
            </div>
          <?php }
                    ...
                    ?>
                      <div class="card">
                        <div class="card-body">
                          ...
                          <p class="card-text"><small class="text-muted">حالة التطبيق: <?php echo $row['application_status'] ?> </small></p>
                          <p class="card-text"><small class="text-muted">تم إنشاء التطبيق: <?php echo $row['application_created'] ?> </small></p>
                        </div>
                      </div>
                    <?php
                  }
            ...
            <div class="col-sm-4">
              ...
              <form class="applicant-form" action="php/signin.php" method="post">
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- <input type="checkbox" name="rememberme" value=""> <span class="remember">تذكرنى</span> -->
                    </div>
    ...
    <?php if(!empty($_GET['status'])) {?>
      ...
      <div class="container d-flex flex-column success-message">
        ...
        <div class="d-flex justify-content-center">
          <h1 class="signup-success">لقد اشتركت بنجاح</h1>
        </div>
        <div class="d-flex justify-content-center">
          <p>شكرا لك على التسجيل!</p>
        </div>
        <div class="d-flex justify-content-center">
          <p><a href="apply.php">انقر هنا</a> للعودة إلى صفحة تسجيل الدخول وتسجيل الدخول إلى حسابك.</p>
        </div>
      </div>
      <!-- End Of Success Page -->
    <?php }?>
